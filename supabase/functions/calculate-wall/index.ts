...
Deno.serve(async (req: any) => {
  ...
  try {
    ...
    L(`Wall Media & Lam`, totalCostMat * wastePct, `Actual SF * Mat Cost * Waste`);
    L(`Latex Ink`, totalActualSqFt * parseFloat(config.Cost_Ink_Latex || "0.16") * wastePct, `Actual SF * Ink Cost * Waste`);
